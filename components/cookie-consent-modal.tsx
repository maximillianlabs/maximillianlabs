    ...
    <AnimatePresence>
      {isVisible ? (
        <motion.div
          ...
          className="fixed bottom-4 left-4 z-[60] w-[min(92vw,23rem)] overflow-hidden rounded-2xl border border-[#00ffff]/20 bg-[#0a0a0a]/95 p-4 text-white shadow-[0_24px_80px_-30px_rgba(0,0,0,0.9)] backdrop-blur-xl sm:bottom-6 sm:left-6 sm:p-5"
        >
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -right-8 -top-8 h-24 w-24 rounded-full bg-[#00ffff]/20 blur-2xl"
          />
          <p className="text-xs tracking-[0.2em] text-[#00ffff]/85">
            COOKIE NOTICE
          </p>
